...
import (
	...
	"github.com/CAP-ALL/kube2consul/Godeps/_workspace/src/golang.org/x/net/context"
	"github.com/CAP-ALL/kube2consul/Godeps/_workspace/src/k8s.io/kubernetes/pkg/auth/user"
)
