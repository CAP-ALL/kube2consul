...
import (
	...
	"github.com/CAP-ALL/kube2consul/Godeps/_workspace/src/github.com/emicklei/go-restful/swagger"
	...
	"github.com/CAP-ALL/kube2consul/Godeps/_workspace/src/k8s.io/kubernetes/pkg/util/yaml"
)
